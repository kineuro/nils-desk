...
export function sections(caps: Capabilities, ready: boolean | null = true, conversations: SidePage[] = []): Section[] {
  ...
  if (assistantOffered(caps)) out.push({ id: "assistant", title: "Assistant", icon: "assistant", pages: [{ id: "new", title: "New conversation", depth: 1 }, ...conversations, { id: "all", title: "All conversations", depth: 1 }, { id: "shared", title: "Shared", depth: 1 }] });
