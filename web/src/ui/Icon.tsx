...
const PATHS = {
  ...
  "thumb-up": (
    <>
      ...
      <path d="M7 10.5 10.8 3.2A2.4 2.4 0 0 1 13.5 5.6V9h5a2 2 0 0 1 2 2.3l-1.2 7A2 2 0 0 1 17.3 20H7" />
    </>
  ),
  "thumb-down": (
    <>
      <path d="M7 13.5V4H4.5A1.5 1.5 0 0 0 3 5.5V12a1.5 1.5 0 0 0 1.5 1.5z" />
      <path d="M7 13.5 10.8 20.8A2.4 2.4 0 0 0 13.5 18.4V15h5a2 2 0 0 0 2-2.3l-1.2-7A2 2 0 0 0 17.3 4H7" />
    </>
  ),
  ...
  "folder-search": (
    <>
      <path d="M11 19H4.5A1.5 1.5 0 0 1 3 17.5v-11A1.5 1.5 0 0 1 4.5 5H9l2 2h8.5A1.5 1.5 0 0 1 21 8.5v2.5" />
      <circle cx="16.5" cy="15.5" r="3" />
      <path d="m18.7 17.7 2.3 2.3" />
    </>
  ),
  "arrow-up": (
    <>
